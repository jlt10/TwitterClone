...
static NSString * const consumerSecret = @"iHQAjHbVNLqVkQqN7ibQe3bRkIhCpwoB9CxcWcjuadZmY0iAqT";// Enter your consumer secret here
...
- (void)getHomeTimelineOlderThanID:(NSString *)idStr completion:(void(^)(NSArray *tweets, NSError *error))completion {
    ...
    NSDictionary *parameters = @{@"max_id": idStr};
    [self GET:@"1.1/statuses/home_timeline.json"
